          ...
          >
            ...
            <div className="p-6">
              ...
              <a
                  ...
                  className="inline-flex items-center gap-2 bg-black text-white px-4 py-2 rounded-md mt-6 hover:bg-gray-800 transition-colors"
                >
                  {project.label === "Dashboard" ? (
                    <>
                      <SiTableau className="w-5 h-5 text-[#E97627]" />
                      View Dashboard
                    </>
                  ) : (
                    <>
